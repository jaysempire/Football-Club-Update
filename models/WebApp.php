   ...
   #   Date modified: 25/10/2024   
	...
	class WebApp
	{
		...
		function createOptions_3( array $data_arr, $sel_id )
      {
        ...
        function productTableItems($product, $upload_url){
			
            $img_url = "$upload_url/products/". $product['img'];

            return '<tr>
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                <img src="'.$img_url.'" alt="'.$product['title'].'" class="img-fluid" style="width: 50px; height: 50px;">
                                <div>
                                    <!-- Button to trigger modal -->
                                    <button class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#imageUploadModal">
                        ...
                        <td>
                            ...
                            <button class="btn btn-warning btn-sm"><i class="bi bi-x-circle"></i> Deactivate</button>
                        </td>
